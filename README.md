...
> This project is about creating a TODO list app using React
...
- **Using Calculator to perform Math operations**
...
```
 git clone https://github.com/wassimchakib/To-Do-react.git
```
